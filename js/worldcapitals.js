...
jQuery(document).ready(function () {
        ...
        function findCapital(code) {
            
            console.log(code);
            var ret ='what?';
            $.ajax({
                url:"http://api.geonames.org/countryInfoJSON?lang=EN&country="+code+"&username=stuli",
                success: function(data) {
                    $("#textregion").text(data["geonames"][0]["capital"]);
